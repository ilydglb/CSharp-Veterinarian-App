...
{
    public partial class FormSahipler : Form
    {
        public FormSahipler()
        {
            InitializeComponent();
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("Select *from Sahipler", con);
        ...
        private void btnKaydet_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@adsyd", txtadsyd.Text);
                cmd.Parameters.AddWithValue("@mail", txtmail.Text);
                cmd.Parameters.AddWithValue("@tel", txtTel.Text);

                cmd.CommandText = "insert into Sahipler (ad_soyad, email,telefon) values (@adsyd, @mail, @tel)";
        ...
        private void btnAra_Click_1(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Select *from Sahipler where ad_soyad=@adsyd OR email=@mail OR telefon=@tel", con);
                cmd.Parameters.AddWithValue("@adsyd", txtArama.Text);
                cmd.Parameters.AddWithValue("@mail", txtArama.Text);
                cmd.Parameters.AddWithValue("@tel", txtArama.Text);
        ...
        private void verisil(int i)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Delete from Sahipler where id=@id", con);
        ...
        private void btnGuncelle_Click_1(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string kayitguncel = ("Update Sahipler Set ad_soyad=@adsyd, email=@mail, telefon=@tel where id=@id ");
        ...
        private void dataGridView1_CellMouseClick_1(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            txtmail.Text = dataGridView1.Rows[i].Cells[2].Value.ToString();
